...
const Banner = () => {
    return (
        <section className='xl:mx-24 mx-8 mb-20'>
            ...
            <p className='pt-3 xl:pb-5 pb-1 text-[#0000008C]'>Ill be sharing my daily article here, Feel free to find inspiration in it</p>
            <Image
                ...
                height={500}
            />
            <p className='text-lg font-semibold xl:mt-3 mt-1'>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nemo, eum.</p>
            <p className="pt-3 pb-5 text-[#00000094] font-normal">Transforming abstract ideas into tangible reality is a captivating journey that requires creativity, skill, and determination. As a designer, my mission is to bridge the gap between imagination and practicalityand determination. As a designer, my mission is to bridge the gap between imagination and practicality.</p>
