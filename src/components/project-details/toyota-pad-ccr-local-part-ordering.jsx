...
const ToyotaPadCcrLocalPartOrdering = ({ otherProjects }) => {
  const project = getProjectBySlug("toyota-pad-ccr-local-part-ordering");
...
export default ToyotaPadCcrLocalPartOrdering;
